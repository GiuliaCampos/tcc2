...
.append("g")
  ...
  // var faturamentos_array = [10, 20, 1000, 3, 5, null];  
  // console.log(d3.extent(ej, function(d){return d.faturamento}));
  // console.log(ej);
  // ej.filter(function(e){ return e.faturamento >= 0});

  $(document).ready(function(){

    var maior = 0;
    var aux = [];
    aux = ej.filter(function(e){ return e.faturamento >= 0});
    console.log( aux);
  }); 
